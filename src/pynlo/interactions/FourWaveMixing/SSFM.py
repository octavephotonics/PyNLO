...
#                printf("[%d] dz = %f\n",self.iter,dz)
 ...
 #        else:
    ...
    def propagate(self, pulse_in, fiber, n_steps, output_power=None, reload_fiber_each_step=False, tshock_correction = 0):
        """
...
#        print "alpha out:",self.alpha
    ...
    def calculate_coherence(self, pulse_in, fiber, 
                            ...
                            n_steps=50, output_power=None, reload_fiber_each_step=False, tshock_correction = 0):
        """
    ...
    def getshocktime(self):
        return 1/self.w0*1e3
